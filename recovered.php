<?php session_start(); ?>
 ...
 if( !isset($_SESSION["customer_email"]) || !isset($_SESSION["customer_success"]))
 {
...
<form action = "process.php" method = "POST">
    <h5>New Password:</h5>
    <input type="password" name="customer_npassword" placeholder="Minimum 8 Characters" required="true" maxlength="35" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"/><br>
     <div class="tip">
    <small>Password must be contain UpperCase, LowerCase, Number/SpecialChar and min 8 Chars</small>
  </div>
    <h5>Retype Password:</h5>
    <input type="password" name="customer_cnpassword" placeholder="Please retype your password" required="true" maxlength="35" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"/>
    <br>
